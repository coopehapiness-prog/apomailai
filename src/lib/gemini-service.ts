...
function getSmartSubOutputs(
  ...
  return {
    ...
    follow_up_scenarios: [
      ...
      `【返信あり・関心あり】\n件名：ご返信ありがとうございます｜デモ日程のご提案\n\nご担当者様\n\nお世話になっております。${senderCompany}の${senderName}です。\n\nお忙しい中ご返信いただき、ありがとうございます。\n\n貴社の「${pain1}」について具体的にお力になれる部分をお見せしたく、30分のオンラインデモをご提案いたします。\n\nデモの内容：\n・貴社の${industry || '業界'}特有の課題に特化した${serviceName}の活用シナリオ\n・実際の画面操作デモ\n・${industry ? industry + '業界' : '同業'}他社様の導入成果と具体的な数字\n\n${schedulingUrl ? `以下のURLからご都合のよい日時をお選びください。\n${schedulingUrl}\n\nもちろん上記以外のお日にちでも対応可能ですので、お気軽にお申し付けください。` : '以下の日程でご都合はいかがでしょうか：\n① 来週火曜 14:00〜14:30\n② 来週木曜 11:00〜11:30\n③ 来週金曜 16:00〜16:30\n\n上記以外でもお気軽にお申し付けください。'}\n\nお会いできることを楽しみにしております。`,
    ],
  };
}
...
パターン3【返信あり・関心あり】：
件名例：「ご返信ありがとうございます｜お打ち合わせ日程のご提案」
本文：丁寧なお礼→30分の打ち合わせで話す内容を3行で説明（${serviceName || '弊社サービス'}で貴社の課題にどう貢献できるかの具体的なシナリオ・活用イメージ・同業界での活用例。サービスの実際の提供内容に基づくこと）→${schedulingUrl ? `日程調整URL（${schedulingUrl}）から候補日時を選んでいただくよう案内` : '具体的な候補日時を3つ提示→「上記以外でもお気軽に」'}→お会いできるのを楽しみにしている旨で締める
