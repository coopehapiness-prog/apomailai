    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-800 rounded-lg border border-slate-700 p-4 space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          {/* Member */}
          <div>
            <label htmlFor="member" className="block text-sm font-medium text-slate-300 mb-1">
              メンバー
            </label>
            <select
              id="member"
          ...
          {/* Period */}
          <div>
            <label htmlFor="period" className="block text-sm font-medium text-slate-300 mb-1">
              期間
            </label>
            <select
              id="period"
                ...
                {expandedFactors[factor.id] && (
                  <div className="px-4 py-3 bg-slate-800 border-t border-slate-600 space-y-2">
                    <div>
                      ...
                      <p className="text-slate-200 text-sm">{factor.factor}</p>
                    </div>
                    {factor.evidenceText && (
                      <div>
                        <h4 className="text-sm font-semibold text-slate-300 mb-2">
